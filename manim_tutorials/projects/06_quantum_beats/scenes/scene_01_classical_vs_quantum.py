...
from utils.latex_formatting import (
    QuantumLatexFormatter, create_quantum_equation, 
    QuantumBeatExpressions
)
...
class ClassicalVsQuantumIntro(Scene):
    ...
    def introduce_quantum_system(self):
        ...
        eigenvalue_eq = create_quantum_equation(
            'energy_eigenvalue_equation'
        ...
        beat_freq_eq = MathTex(
            QuantumBeatExpressions.CLASSICAL_BEATING['quantum_energy_difference'],
            font_size=40,
            color=QUANTUM_GOLD
